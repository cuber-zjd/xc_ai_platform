...
- Insight 飞书月报中的原文链接必须自然嵌入“主体+动作”事件短语，禁止使用“原文、来源、详情、点击查看”等无语义链接文字；“月度关键市场信息解读”每条事件必须至少保留一个正文内可回溯链接。健源月报必须围绕大豆与植物蛋白业务，御馨月报必须围绕玉米深加工与糖类业务，跨产业公司主线由确定性发布门禁拦截，不能只依赖提示词约束。
