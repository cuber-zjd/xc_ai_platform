...
class InsightDataSource(BaseDBModel, table=True):
    ...
    monitor_object_type: str | None = Field(default=None, index=True, max_length=30)
    monitor_object_id: int | None = Field(default=None, index=True)
    execution_role: str | None = Field(default=None, index=True, max_length=50)
    generation_mode: str = Field(default="manual", index=True, max_length=30)
    collection_strategy: str = Field(default="standard", index=True, max_length=30)
