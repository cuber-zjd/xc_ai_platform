...
def crawl_toutiao(keyword):
    ...
    with sync_playwright() as p:
        ...
        url = f"https://so.toutiao.com/search/?dvpf=pc&pd=information&keyword={keyword}"
        ...
        for card in cards:
            try:
                ...
                author = parts[0].strip() if len(parts) > 0 and parts[0].strip() else "头条新闻"
