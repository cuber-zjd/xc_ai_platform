...
def crawl_china(keyword):
    # 采用今日头条资讯代理方案，精确检索“中华网”关于新茶饮的报道
    search_kw = f"中华网 {keyword}"
    print(f"开始利用头条平台间接爬取中华网 - 检索词: '{search_kw}'")
    articles = []
